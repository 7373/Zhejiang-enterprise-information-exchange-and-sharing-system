                ...
                columnDefs: [
...

                    {
                        ...
                        render: function (data, type, row, meta) {
                            var del = "";
                            if (row.pubFlag != "1") {
                                del = "<a  href='#' class='js-deletAct' id=" + row.paidID + " title=" + row.pubFlag + ">删除</a>";
                            }

                            return " <a   href='#' class='js-editAct' id=" + row.paidID + " title=" + row.pubFlag + ">修改&nbsp;&nbsp;</a>" + del;
                ...
                columnDefs: [
...

                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            var del = "";
                            if (row.pubFlag != "1") {
                                del = "<a  href='#' id=" + row.subID + " class='js-delete'   title=" + row.pubFlag + ">删除</a>";
                            }

                            return " <a   href='#' class='js-edit' id=" + row.subID + " title=" + row.pubFlag + ">修改&nbsp;&nbsp;</a>" + del;
