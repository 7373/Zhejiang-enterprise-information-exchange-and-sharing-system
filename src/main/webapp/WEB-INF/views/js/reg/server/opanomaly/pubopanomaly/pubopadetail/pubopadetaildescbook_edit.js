require(['component/iframeLayer', 'common/util', 'common/http', 'jquery.validate', 'jquery.serialize','common/validateRules','laydate'], function (layer, util, http) {
    ...
    function initdecisionBookInfo(){
    	...
    	//此处的数据字典根据决定书的数据完成
    	var remExcpresList = [
                        	{id: "1", text: "列入经营异常名录3年内且已补报未报年份的年度报告并公示"},
                        	{id: "2", text: "列入经营异常名录3年内且已履行公示义务"},
                        	{id: "3", text: "列入经营异常名录3年内且已更正其公示的信息"},
                        	{id: "4", text: "列入经营异常名录3年内且已依法办理住所或者经营场所变更登记"},
                        	{id: "5", text: "列入经营异常名录3年内且通过登记的住所或者经营场所可以重新取得联系"}
                        ];
    		//企业判断
