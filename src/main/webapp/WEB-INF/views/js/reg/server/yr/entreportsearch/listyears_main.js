        ...
        util.bindEvents([
        	{
                ...
                handler: function () {
					...
					layer.dialog({
                		...
                		content: '/server/yr_view/tab?priPID='+priPID+'&year='+year+'&entType='+entType+"&entTypeCatg="+entTypeCatg+"&regNO="+regNO+"&entName="+entName+"&uniscid="+uniscid+"&estDate="+estDate+"&altDate="+data.altDate,
