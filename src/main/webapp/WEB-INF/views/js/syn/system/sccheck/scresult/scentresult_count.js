           ...
           columnDefs: [
						{
						    ...
						    render: function (data, type, row, meta) {
						       if(row.totalNum !=0 && row.totalNum != null){
						    	   return ((row.finishedNum/row.totalNum)*100).toFixed(2)+"%";   
						       }
						   }
					    },{
							targets: 6,
           ...
           "footerCallback": function ( row, data, start, end, display ) {
               ...
               if(data!=null&&data.length!=0){
                   for(var c=0;c<dataArr.length;c++){ 
                      ...
                      if(c ==2){
                    	  var finishedNum = $(api.column(dataArr[1]).footer()).html();
                    	  if(finishedNum != ""){
                    	  ...
                    	  if(totalNum != 0){
                    		  ...
                    		  $(api.column(dataArr[2]).footer()).html(finishPerCount); 
                    	  }
                      }else if(c == 21){
                    	  var disposeNum = $(api.column(dataArr[20]).footer()).html();
                    	  if(disposeNum != ""){
                    	  ...
                    	  if(finishedNum != 0){
                    		  ...
                    		  $(api.column(dataArr[21]).footer()).html(finishPerCount); 
                    	  }
                      }else{
