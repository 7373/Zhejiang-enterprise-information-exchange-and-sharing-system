    ...
    function loadMortData(page, length, callback) {
        ...
        http.httpRequest({
            ...
            success: function (data) {
                ...
                var handleHelper = handlebars.registerHelper("xh", function(index) {return index+1+(page*5);});//序号
                handlebars.registerHelper("cancelStatus", function(cancelStatus) {return cancelStatus == 0 ? "有效" : "-";});
                handlebars.registerHelper("checkDate", function(checkDate) {
                	if(checkDate != null && checkDate != "") {
                		return util.dateFormat(new Date(util.dateTransform(checkDate)),"yy年mm月dd日");
                	}else{
                		return "";
                	}
            	});
...
//                		return data.impBLicNO.substring(0,12) + "***";
                ...
                handlebars.registerHelper("recDate", function(recDate) {
                	if(recDate != null && recDate != "") {
                		return util.dateFormat(new Date(util.dateTransform(recDate)),"yy年mm月dd日");
                	}else{
                		return "";
                	}
            	});
                ...
                handlebars.registerHelper("equPleDate", function(equPleDate) {
                	if(equPleDate != null && equPleDate != "") {
                		return util.dateFormat(new Date(util.dateTransform(equPleDate)),"yy年mm月dd日");
                	}else{
                		return "";
                	}
            	});
