                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       ...
	                       <table id="table2" cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                            ...
	                            <tr>
	                                ...
	                                <td class="bg-gray center" width="25%">发现问题情况</td>
	                                <td class="bg-gray center" width="25%">处置情况</td>
	                            </tr>
	                            <c:forEach var="pubSccheckItemResultList" items="${pubSccheckItemResultList }" varStatus="status">
		                            <tr>
		                                ...
		                                <td><textarea class="prodis" 
		                                	<c:if test="${empty pubSccheckItemResultList.problem }"> style="display: none" </c:if> 
		                               id="problem_${pubSccheckItemResultList.checkCode }" name="problem_${pubSccheckItemResultList.checkCode }" >${pubSccheckItemResultList.problem }</textarea></td>
		                                <td><textarea class="prodis" 
		                                	<c:if test="${empty pubSccheckItemResultList.dispose }"> style="display: none" </c:if> 
	                       ...
	                       <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       		<tr>
	                       			<td class="bg-gray right" width="20%">后续处置措施是否已经执行完结</td>
	                       			<td width="45%">
	                       			...
	                       			<td width="20%"><input type="text" name="disposeFinishDate" class="ipt-txt laydate-icon" onclick="laydate()" readonly="readonly" value="<fmt:formatDate value='${pubScentResultDto.disposeFinishDate }' pattern='yyyy-MM-dd'/>"/></td>
	                       		</tr>
	                       		<tr>
