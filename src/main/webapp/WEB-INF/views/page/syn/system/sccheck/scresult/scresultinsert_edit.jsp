                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       ...
	                       <table id="table2" cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                            ...
	                            <tr>
	                                ...
	                                <td class="bg-gray center" width="20%">
	                                	<span class="light">*</span>是否检查
	                                	<input type="checkbox" id="checkAll" value="1">全选
	                                </td>
	                                <td class="bg-gray center" width="22%"><span class="light">*</span>发现问题情况 <input type="checkbox" class="problemno" value="2">全选“无”</td>
	                                <td class="bg-gray center" width="22%"><span class="light">*</span>处置情况 <input type="checkbox" class="disposeno" value="3">全选“无”</td>
	                            </tr>
	                            <c:forEach var="pubSccheckItem" items="${pubSccheckItemList1 }" varStatus="status">
		                            <tr>
		                                ...
		                                <td><textarea class="prodis" style="display: none" id="problem_${pubSccheckItem.checkCode }" name="problem_${pubSccheckItem.checkCode }"></textarea></td>
		                                <td><textarea class="prodis" style="display: none" id="dispose_${pubSccheckItem.checkCode }" name="dispose_${pubSccheckItem.checkCode }"></textarea></td>
		                            </tr>
	                            </c:forEach>
	                            <c:forEach var="pubSccheckItem" items="${pubSccheckItemList2 }" varStatus="status">
		                            <tr>
		                                ...
		                                <td><textarea class="prodis" style="display: none" id="problem_${pubSccheckItem.checkCode }" name="problem_${pubSccheckItem.checkCode }" ></textarea></td>
		                                <td><textarea class="prodis" style="display: none"
	                       ...
	                       <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       	  <tbody>
	                            <tr>
	                                <td class="bg-gray center"><span class="light">*</span>核查方式(多选)</td>
	                                <td colspan="2">
	                            ...
	                            <tr>
	                                ...
	                                <td><input class="crt" type="checkbox" value="1" name="checkResultTmp" width="40%">未发现违法行为</td>
	                                <td><input class="crt" type="checkbox" value="6" name="checkResultTmp" width="40%">查无下落
	                            </tr>
	                            <tr>
	                       ...
	                       <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       		<tr>
	                       			<td class="bg-gray right"><span class="light">*</span>后续处置措施是否已经执行完结</td>
	                       			<td><input type="radio" value="1" name="disposeState" class="dis" checked="checked">未完结 
	                       				<input type="radio" value="2" name="disposeState" class="dis">已完结</td>
	                       			<td class="bg-gray right"><span class="sp"><span class="light">*</span>完结日期</span></td>
	                       			<td><span class="sp"><input type="text" id="disposeFinishDate" name="disposeFinishDate" class="ipt-txt laydate-icon" onclick="laydate()" readonly="readonly" value=""/></span></td>
	                       		</tr>
	                       		<tr>
