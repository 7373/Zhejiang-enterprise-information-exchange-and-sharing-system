...
<div>
    <table class="table-horizontal">
       ...
       <tr id="setTr">
           <td class="bg-gray right">检查对象抽取库设置：</td>
           <td>
               <div class="ipt-box col-12">
               		<a href="javascript:void(0);" id="addPage">添加检查对象</a>&nbsp;&nbsp;&nbsp;&nbsp;
               		<a href="javascript:void(0);" id="delEntBack">删除检查对象</a>&nbsp;&nbsp;&nbsp;&nbsp;
               		<a href="javascript:void(0);" id="exportEntBack">导入检查对象名单</a>&nbsp;&nbsp;&nbsp;&nbsp;
<!--                		<a href="javascript:void(0);" id="exportSpecial">导入专项检查对象库</a>&nbsp;&nbsp;&nbsp;&nbsp; -->
               		<a href="javascript:void(0);" id="cleanEntBack">清空检查对象</a>
               </div>
           </td>
       </tr>
       <tr>
           <td class="bg-gray right">入库对象筛选条件<br/>说明（2000字内）：</td>
            <td>
                <div class="ipt-box">
                    <textarea id="taskCondition" name="taskCondition" class="min-h100 required" placeholder="请对入库对象的筛选条件信息进行必要说明，以方便查看">${pubScPlanTask.taskCondition }</textarea>
                </div>
            </td>
        </tr>
    </table>
...
<h5 class="h5-title" id="seth5">检查对象抽取条件设置：<input type="button" id="confirm" value="确认本次检查对象抽取库" class="btn mr20"></h5>
<h5 class="h5-title">
	<span>
	请选择抽取模式：<input type="radio" id="checkType1" class="checkType" name="checkType" value="1" <c:if test="${pubScPlanTask.randomType == '1'}">checked="checked"</c:if> />按综合主体库统一抽取
	<input type="radio" id="checkType2" class="checkType" name="checkType" value="2" <c:if test="${pubScPlanTask.randomType == '2'}">checked="checked"</c:if> />
	按专项检查对象库分类抽取
	</span>
