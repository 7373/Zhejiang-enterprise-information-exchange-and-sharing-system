                    ...
                    <div class="mt10">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       ...
	                       <table id="table2" cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal table-form">
	                       	  <tbody>
	                            <tr>
	                                <td class="bg-gray center" width="30%">检查事项</td>
	                                <td class="bg-gray center" width="20%">
	                                	<span class="light">*</span>是否检查
	                                	<input type="checkbox" id="checkAll">全选
	                                </td>
	                                <td class="bg-gray center" width="25%"><span class="light">*</span>发现问题情况</td>
	                                <td class="bg-gray center" width="25%"><span class="light">*</span>处置情况</td>
	                            </tr>
	                       ...
	                       <input type='hidden' id="disposeState" value="${pubScentResultDto.disposeState }">
	                       		<tr>
	                       			<td class="bg-gray right" width="20%"><span class="light">*</span>后续处置措施是否已经执行完结</td>
	                       			<td width="45%">
	                       			...
	                       			<td width="20%"><span class="sp"><input type="text" id="disposeFinishDate" name="disposeFinishDate" class="ipt-txt laydate-icon" onclick="laydate()" readonly="readonly" value="<fmt:formatDate value='${pubScentResultDto.disposeFinishDate }' pattern='yyyy-MM-dd'/>"/></span></td>
	                       		</tr>
	                       		<tr>
