...
<div class="header clearfix">
    <a href="#" class="logo fl">
        <img src="/img/syn/logo.png" alt="" class="fl"/>
        <h1 class="fl" style="text-align:center">
            <div>浙江企业信息交换共享平台</div>
    ...
    <div class="hd-nav">
        <ul class="clearfix">
            <li class="popup">
                <a href="##">欢迎您！${sessionScope.session_sys_user.realName} （${sessionScope.session_sys_user.sysDepart.orgName}）<i class="xbt-icon trangle-icon"></i><em class="border-hide"></em> </a>
