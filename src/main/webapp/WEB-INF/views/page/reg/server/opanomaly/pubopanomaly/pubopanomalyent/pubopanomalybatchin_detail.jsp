...
<%--                                         ${pubOpanoMaly.regState } --%>
                                         <c:if test="${fn:indexOf('K, B, A',pubOpanoMaly.regState) != -1 || pubOpanoMaly.regState == 'X' || pubOpanoMaly.regState == 'Q' || pubOpanoMaly.regState == 'DA' }">存续</c:if>
                                         <c:if test="${pubOpanoMaly.regState == 'C'}">撤销</c:if>
                                         <c:if test="${pubOpanoMaly.regState == 'D'}">吊销</c:if>
