...
<div class="tabbale" data-component="tab"> 
    <form id="taskForm" class="form-box">
         <div class="form-list">
             <input type="hidden"  name="entTypeCatg" id="entTypeCatg" value="11,12,13,14,15,31,32,33,34,21,22,23,24,25,26,27,28" >
     ...
     <div class="clearfix mb5 mt5">
     	<p class="fl"><input type="button" class="btn btn-sm mr5" value="返回" id="backpubOpanoMalyList"></p>
	 	<p class="fl"><input type="button" class="btn btn-sm mr5" value="列入异常申请" id="pubOpanoMalyapply"></p>
      </div>
...
<script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopanomalyent/pubopanomalyentapply_list_main.js"/>"></script>  
