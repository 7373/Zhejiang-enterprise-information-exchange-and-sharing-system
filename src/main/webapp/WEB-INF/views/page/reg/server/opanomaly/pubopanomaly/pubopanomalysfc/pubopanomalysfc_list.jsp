...
<head>
    ...
    <title>经营异常名录申请列表</title>
    <link rel="stylesheet" href="/css/vendor/dataTables.bootstrap.min.css">
    <link rel="stylesheet" href="/css/reg.server.css">
</head>
<body class="pd10">
<div class="tabbale" data-component="tab">
    <form id="searchForm" class="form-box pd14-mr">
        <div class="form-list">
    ...
    <div class="clearfix mb5 mt5">
        <p class="fl"><input type="button" class="btn btn-sm mr5" value="新增列入记录" id="showpubOpanoMalySfcList"></p>
    </div>
    <div class="light-info mb5">
        <span class="light"> 提示：查询范围为当前时点的在册农民专业合作社。审核后可打印“经营异常名录审批表”，予以列入情况下可打印“列入经营异常名录决定书”。予以列入信息将自动公示于公示系统。</span>
    ...
    <div class="tab-content">
        <div class="tab-panel tab-panel-show">
            <div class="">
                <div class="table-out">
                    <table id="ent_table"  border="0" cellspacing="0" cellpadding="0" class="table-row mt30 nowrap" width="100%">
                        <thead>
                        <tr>
...
<!--                             <th>成立日期</th> -->
    ...
    <script src="/js/reg/server/opanomaly/pubopanomaly/pubopanomalysfc/pubopanomalysfc_list_main.js"></script>
</body>
</html>