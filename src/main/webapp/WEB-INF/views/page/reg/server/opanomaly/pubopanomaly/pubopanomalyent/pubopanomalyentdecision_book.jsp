	...
	<c:if test="${pubOpanoMaly.batchEntType==1 && pubOpanoMaly.impFlag==1 && pubOpanoMaly.speCause != 1}"><!-- 企业单个新增决定书 -->
		   <div id="ent" style="width:675px; margin:0 auto; page-break-before:auto; *height:600px; _height:600px;position: relative">
			...
			<p class=p0 style="text-indent: 32.0000pt; margin-bottom: 0pt; margin-top: 0pt; line-height: 28.0000pt;">
				...
				<span style="mso-spacerun: 'yes'; letter-spacing: 1.0000pt; font-size: 16.0000pt; font-family: '仿宋_GB2312';">的相关规定。根据《企业信息公示暂行条例》第十七条第一款和《经营异常名录管理暂行办法》第</span>
				...
				<span style="mso-spacerun: 'yes'; font-size: 16.0000pt; font-family: '仿宋_GB2312';">条的规定，现决定将你单位列入经营异常名录。</span>
			</p>
		...
		<c:if test="${pubOpanoMaly.batchEntType==2 && pubOpanoMaly.impFlag==1 && pubOpanoMaly.speCause != 1}"><!-- 农专单个新增决定书 -->
		   <div id="farm" style="width:675px; margin:0 auto; page-break-before:auto; *height:600px; _height:600px;position: relative">
				...
				<p class=p0
					...
					<span style="mso-spacerun: 'yes'; letter-spacing: 1.0000pt; font-size: 16.0000pt; font-family: '仿宋_GB2312';">，违反了《企业信息公示暂行条例》和《农民专业合作社年度报告公示暂行办法》</span>
					<span style="mso-spacerun: 'yes'; letter-spacing: 1.0000pt; font-size: 16.0000pt; font-family: '仿宋_GB2312';">的相关规定。根据《企业信息公示暂行条例》第十七条第一款和《农民专业合作社年度报告公示暂行办法》第</span>
