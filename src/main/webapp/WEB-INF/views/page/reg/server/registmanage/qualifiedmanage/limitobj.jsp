...
<div id="ent" style="display: none">
	...
	<div style="margin-top: 2px;">
	<!-- 
		<input type="button" id="js-guide" value="行政指导" class="btn mr20">
		<input type="button" id="js-rec" value="责令整改" class="btn mr20">
		<input type="button" id="js-insobj" value="列入检查对象" class="btn mr20">
		<input type="button" id="js-keysup" value="列入重点监管" class="btn mr20">
    -->
