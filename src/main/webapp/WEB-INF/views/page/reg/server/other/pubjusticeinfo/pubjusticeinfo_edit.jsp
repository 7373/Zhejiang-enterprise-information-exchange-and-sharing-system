        	...
        	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="table-horizontal mt10">
	            <tr>
					...
					<tr>
						...
						<td _width="10%" width="10%" class="bg-gray right"><span style="color:red">* </span>单位</td>
						<td _width="30%" width="30%">
						   <div class="ipt-box pd0">
								...
								<p style="color: red;">(例如:万元，万股，万美元)</p>
						   </div>
						</td>
					</tr>
					<tr class="commonType froType">
						...
						<td colspan="3">
						  <div class="ipt-box pd0">
						   <input type="text" class="inType ipt-txt" style="width: 100px;cursor: pointer;" id="froFrom"  onclick="laydate()" readonly="readonly"
					...
					<tr class="commonType froType">
						...
						<td colspan="3">
						  <div class="ipt-box pd0">
						   <input type="text" style="width: 100px;cursor: pointer;" id="froTo"  onclick="laydate()" readonly="readonly"
					...
					<tr class="commonType froType">
						...
						<td colspan="3">
						  <div class="ipt-box pd0">
								...
								<p style="color: red;">指冻结时间长度，如1年</p>
						  </div>
						</td>
					</tr>
