...
<div class="tabbale" data-component="tab">
    ...
    <div class="light-info mb5 mt5">
        <span class="light"> 提示：查询范围为当前时点本局登记的在册农民专业合作社。审核后可打印“经营异常名录审批表”，予以列入情况下可打印“列入经营异常名录决定书”。予以列入信息将自动公示于公示系统。</span>
...
<!--                             <th>成立日期</th> -->
    ...
    <script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopanomalysfc/pubopanomalysfcaudit_list_main.js"/>"></script>
