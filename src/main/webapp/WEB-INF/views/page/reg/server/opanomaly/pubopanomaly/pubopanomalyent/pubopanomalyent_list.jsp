...
<div class="tabbale" data-component="tab">
    ...
    <div class="clearfix mt5">
        <p class="fl"><input type="button" class="btn btn-sm mr5" value="新增列入记录" id="showpubOpanoMalyList"></p>
    </div>
...
<!--                             <th>成立日期</th> -->
    ...
    <script src="<c:url value="/js/reg/server/opanomaly/pubopanomaly/pubopanomalyent/pubopanomalyent_list_main.js"/>"></script>
</body>
</html>