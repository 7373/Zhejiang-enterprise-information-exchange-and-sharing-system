        ...
        <div class="content js-content-show js-table">
            <table class="table-public table-web" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <th width="98" class="bg">认缴出资额<br/><strong class="light">(${year>2015?midBaseInfoDto.currencyCn:'元人民币'})</strong></th>
                    <th width="118" class="bg">出资方式<br/>（认缴）</th>
                    <th width="108" class="bg">认缴出资日期</th>
                    <th width="100" class="bg">实缴出资额<br/><strong class="light">(${year>2015?midBaseInfoDto.currencyCn:'元人民币'})</strong></th>
