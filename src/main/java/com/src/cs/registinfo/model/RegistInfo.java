...
/**
 * 描述:  cs_regist_info 对应的实体类.<br>
 * WARNING：不是表中字段的属性必须加@Transient注解
 * @author framework generator
 * @date 2016年10月24日
 */
@Table(name = "cs_regist_info")
public class RegistInfo implements Serializable {
    ...
    /**
     * 获取认领状态：0未认领；1已认领；3超时未认领；4超时认领
     *
     * @return ClaimState - 认领状态：0未认领；1已认领；3超时未认领；4超时认领
     */
    ...
    /**
     * 设置认领状态：0未认领；1已认领；3超时未认领；4超时认领
     *
     * @param claimState 认领状态：0未认领；1已认领；3超时未认领；4超时认领
     */
    ...
    /**
     * 获取分配来源：1委托,2自管，3系统自动
     *
     * @return RegistSource - 分配来源：1委托,2自管，3系统自动
     */
    ...
    /**
     * 设置分配来源：1委托,2自管，3系统自动
     *
     * @param registSource 分配来源：1委托,2自管，3系统自动
     */
