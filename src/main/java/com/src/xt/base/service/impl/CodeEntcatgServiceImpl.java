...
public class CodeEntcatgServiceImpl extends MyBatisServiceSupport implements ICodeEntcatgService {
	...
	public List<Map<String, Object>> selectToTreeMap() {
		...
		return codeEntcatgMapper.selectToTreeMap();
	}

	@Override
	public List<Map<String, Object>> selectToTreeMapNoCheck() {
		 
		return codeEntcatgMapper.selectToTreeMapNoCheck();
	}
	...
	@Override
	public List<Map<String, Object>> selectToTreeMapByType(String type) {
