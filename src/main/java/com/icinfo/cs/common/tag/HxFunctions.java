...
public class HxFunctions {
    ...
    public static String publicStatus(String code){
        ...
        String [] str1_arry = {"K","B","A","DA","X","Q"}; //存续
        ...
        if(StringUtil.equalsIgnoreCase(str4,code)){return "吊销";}
    ...
    public static String publicStatusStyle(String code){
        ...
        if(StringUtil.equalsIgnoreCase(str4,code)){return "icon-blue";} //吊销
     ...
     * @return
     */
    public static String yReportStyle(String code){
        ...
        if(StringUtil.equalsIgnoreCase(str4,code)){return "icon-rectangle red fl";} //吊销
