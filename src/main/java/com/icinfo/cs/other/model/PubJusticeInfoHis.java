...
/**
 * 描述:    cs_pub_justiceinfo_his 对应的实体类.<br>
 * WARNING：不是表中字段的属性必须加@Transient注解
 * @author framework generator
 * @date 2016年10月20日
 */
@Table(name = "cs_pub_justiceinfo_his")
public class PubJusticeInfoHis implements Serializable {
    /**
     * 自增主键ID
     */
    @Id
    ...
    /**
     * 证件（证照）类型 ：1：居民身份证、2：外国(地区)护照、3：军官证、4：其他有效身份证件 5：营业执照 
     */
    @Column(name = "CerType")
    ...
    /**
     * 受让人证件（证照）类型： 1：居民身份证、2：外国(地区)护照、3：军官证、4：其他有效身份证件 5：营业执照 
     */
