...
public class WritServerController extends BaseController {
    ...
    /*添加文书调用的接口是：  WritServiceImpl 类中的  writService.addWrit()     */


    //添加文书内容
   /* writService.addWrit(new Writ(pubOpanoMaly.getPriPID(),writNo,WritTypeEnum.WRIT_TYPE_LieRuYiChang.getType(),pubOpanoMaly.getBusExcList(),pubOpanoMaly.getYear()));
