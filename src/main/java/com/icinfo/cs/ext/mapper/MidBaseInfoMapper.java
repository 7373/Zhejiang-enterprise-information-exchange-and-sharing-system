...
public interface MidBaseInfoMapper extends Mapper<MidBaseInfo> {
     ...
     * @date 2016年8月29日
     */
    MidBaseInfoDto selectMidBaseInfoByPripidForLogin(@Param("pripid") String pripid, @Param("systemType") String systemType);
     ...
     * @date 2016年8月29日
     */
    MidBaseInfoDto selectByRegnoAndEntname(@Param("regno") String regno, @Param("entname") String entname, @Param("systemType") String systemType);
